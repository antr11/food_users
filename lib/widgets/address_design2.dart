...
class AddressDesign2 extends StatefulWidget {
  final Address? model;
  ...
  @override
  _AddressDesign2State createState() => _AddressDesign2State();
}

class _AddressDesign2State extends State<AddressDesign2> {
  @override
